...
architecture STRUCTURE of lab_3_Multiplier_0_0_MultController is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_pr_state[0]_i_1\ : label is "soft_lutpair1";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_onehot_pr_state_reg[0]\ : label is "s1:010,s2:100,s0:001";
  attribute FSM_ENCODED_STATES of \FSM_onehot_pr_state_reg[1]\ : label is "s1:010,s2:100,s0:001";
  attribute FSM_ENCODED_STATES of \FSM_onehot_pr_state_reg[2]\ : label is "s1:010,s2:100,s0:001";
  attribute XILINX_LEGACY_PRIM : string;
  attribute XILINX_LEGACY_PRIM of ld_mult_reg : label is "LDP";
  attribute OPT_MODIFIED : string;
  attribute OPT_MODIFIED of multiplicand_shift_reg : label is "MLO ";
...
begin
  ...
  ld <= \^ld\;
\FSM_onehot_pr_state[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FE00"
    )
        port map (
...
ld_mult_reg: unisim.vcomponents.LDPE
    generic map(
      INIT => '1'
    )
        port map (
...
entity lab_3_Multiplier_0_0_flipflop_66 is
  port (
    ...
    q_reg_0 : out STD_LOGIC;
    \FSM_onehot_pr_state_reg[2]\ : in STD_LOGIC_VECTOR ( 2 downto 0 );
    en : in STD_LOGIC;
    q_reg_1 : in STD_LOGIC;
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
...
architecture STRUCTURE of lab_3_Multiplier_0_0_flipflop_66 is
  ...
  signal multiplier : STD_LOGIC_VECTOR ( 12 to 12 );
begin
\FSM_onehot_pr_state[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0E0E0E0E0E0E0E0A"
    )
        port map (
      I0 => Q(0),
      I1 => Q(1),
...
\FSM_onehot_pr_state[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
entity lab_3_Multiplier_0_0_flipflop_69 is
  port (
    q_reg_0 : out STD_LOGIC;
    q_reg_1 : out STD_LOGIC;
    done_INST_0_i_1 : in STD_LOGIC_VECTOR ( 2 downto 0 );
    en : in STD_LOGIC;
    q_reg_2 : in STD_LOGIC;
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
...
architecture STRUCTURE of lab_3_Multiplier_0_0_flipflop_69 is
  signal multiplier : STD_LOGIC_VECTOR ( 15 to 15 );
begin
...
entity lab_3_Multiplier_0_0_flipflop_73 is
  port (
    q_reg_0 : out STD_LOGIC;
    q_reg_1 : out STD_LOGIC;
    done_INST_0_i_3 : in STD_LOGIC_VECTOR ( 2 downto 0 );
    en : in STD_LOGIC;
    q_reg_2 : in STD_LOGIC;
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
...
architecture STRUCTURE of lab_3_Multiplier_0_0_flipflop_73 is
  signal multiplier : STD_LOGIC_VECTOR ( 19 to 19 );
begin
...
architecture STRUCTURE of lab_3_Multiplier_0_0_flipflop_78 is
  ...
  signal multiplier : STD_LOGIC_VECTOR ( 23 to 23 );
begin
...
architecture STRUCTURE of lab_3_Multiplier_0_0_flipflop_82 is
  signal multiplier : STD_LOGIC_VECTOR ( 27 to 27 );
begin
...
entity lab_3_Multiplier_0_0_flipflop_89 is
  port (
    q_reg_0 : out STD_LOGIC;
    q_reg_1 : out STD_LOGIC;
    done : in STD_LOGIC_VECTOR ( 2 downto 0 );
    en : in STD_LOGIC;
    q_reg_2 : in STD_LOGIC;
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
...
architecture STRUCTURE of lab_3_Multiplier_0_0_flipflop_89 is
  signal multiplier : STD_LOGIC_VECTOR ( 4 to 4 );
begin
...
entity lab_3_Multiplier_0_0_flipflop_92 is
  port (
    q_reg_0 : out STD_LOGIC;
    q_reg_1 : out STD_LOGIC;
    done_INST_0_i_2 : in STD_LOGIC_VECTOR ( 2 downto 0 );
    en : in STD_LOGIC;
    q_reg_2 : in STD_LOGIC;
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
...
architecture STRUCTURE of lab_3_Multiplier_0_0_flipflop_92 is
  signal multiplier : STD_LOGIC_VECTOR ( 7 to 7 );
begin
...
architecture STRUCTURE of lab_3_Multiplier_0_0_ShiftRegister is
  ...
  signal \gen_shiftreg[12].reg_n_3\ : STD_LOGIC;
  ...
  signal multiplier : STD_LOGIC_VECTOR ( 31 downto 1 );
begin
...
\gen_shiftreg[12].reg\: entity work.lab_3_Multiplier_0_0_flipflop_66
     port map (
      ...
      \FSM_onehot_pr_state_reg[2]\(2) => multiplier(13),
      \FSM_onehot_pr_state_reg[2]\(1 downto 0) => multiplier(11 downto 10),
...
\gen_shiftreg[15].reg\: entity work.lab_3_Multiplier_0_0_flipflop_69
     port map (
      ...
      CO(0) => CO(0),
      clk => clk,
      done_INST_0_i_1(2 downto 1) => multiplier(17 downto 16),
      done_INST_0_i_1(0) => multiplier(14),
      en => en,
      ld => ld,
...
\gen_shiftreg[19].reg\: entity work.lab_3_Multiplier_0_0_flipflop_73
     port map (
      ...
      CO(0) => CO(0),
      clk => clk,
      done_INST_0_i_3(2 downto 1) => multiplier(21 downto 20),
      done_INST_0_i_3(0) => multiplier(18),
      en => en,
      ld => ld,
...
\gen_shiftreg[23].reg\: entity work.lab_3_Multiplier_0_0_flipflop_78
     port map (
      ...
      CO(0) => CO(0),
      clk => clk,
      done(5 downto 4) => multiplier(31 downto 30),
      done(3 downto 2) => multiplier(25 downto 24),
      done(1) => multiplier(22),
      done(0) => multiplier(1),
...
\gen_shiftreg[27].reg\: entity work.lab_3_Multiplier_0_0_flipflop_82
     port map (
      ...
      CO(0) => CO(0),
      clk => clk,
      done_INST_0_i_3(2 downto 1) => multiplier(29 downto 28),
      done_INST_0_i_3(0) => multiplier(26),
      en => en,
      ld => ld,
...
\gen_shiftreg[4].reg\: entity work.lab_3_Multiplier_0_0_flipflop_89
     port map (
      ...
      done(1 downto 0) => multiplier(3 downto 2),
...
\gen_shiftreg[7].reg\: entity work.lab_3_Multiplier_0_0_flipflop_92
     port map (
      ...
      CO(0) => CO(0),
      clk => clk,
      done_INST_0_i_2(2 downto 1) => multiplier(9 downto 8),
      done_INST_0_i_2(0) => multiplier(6),
      en => en,
      ld => ld,
...
alu: entity work.lab_3_Multiplier_0_0_Adder
     port map (
      I2(62 downto 0) => sl_map(63 downto 1),
...
controller: entity work.lab_3_Multiplier_0_0_MultController
     port map (
      ...
      D(1) => multiplier_reg_n_34,
      D(0) => multiplier_reg_n_35,
      Q(2) => controller_n_0,
      Q(1) => controller_n_1,
      Q(0) => controller_n_2,
      clk => clk,
...
multiplicand_in1_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => multiplier_reg_n_1,
      DI(2) => multiplier_reg_n_2,
      DI(1) => multiplier_reg_n_3,
      DI(0) => multiplier_reg_n_4,
      O(3 downto 0) => NLW_multiplicand_in1_carry_O_UNCONNECTED(3 downto 0),
      S(3) => multiplier_reg_n_5,
      S(2) => multiplier_reg_n_6,
      S(1) => multiplier_reg_n_7,
      S(0) => multiplier_reg_n_8
    );
\multiplicand_in1_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => multiplier_reg_n_9,
      DI(2) => multiplier_reg_n_10,
      DI(1) => multiplier_reg_n_11,
      DI(0) => multiplier_reg_n_12,
      O(3 downto 0) => \NLW_multiplicand_in1_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => multiplier_reg_n_13,
      S(2) => multiplier_reg_n_14,
      S(1) => multiplier_reg_n_15,
      S(0) => multiplier_reg_n_16
    );
\multiplicand_in1_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => multiplier_reg_n_17,
      DI(2) => multiplier_reg_n_18,
      DI(1) => multiplier_reg_n_19,
      DI(0) => multiplier_reg_n_20,
      O(3 downto 0) => \NLW_multiplicand_in1_carry__1_O_UNCONNECTED\(3 downto 0),
      S(3) => multiplier_reg_n_21,
      S(2) => multiplier_reg_n_22,
      S(1) => multiplier_reg_n_23,
      S(0) => multiplier_reg_n_24
    );
\multiplicand_in1_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => multiplier_reg_n_25,
      DI(2) => multiplier_reg_n_26,
      DI(1) => multiplier_reg_n_27,
      DI(0) => multiplier_reg_n_28,
      O(3 downto 0) => \NLW_multiplicand_in1_carry__2_O_UNCONNECTED\(3 downto 0),
      S(3) => multiplier_reg_n_29,
      S(2) => multiplier_reg_n_30,
      S(1) => multiplier_reg_n_31,
      S(0) => multiplier_reg_n_32
    );
...
multiplier_reg: entity work.lab_3_Multiplier_0_0_ShiftRegister
     port map (
      A(31 downto 0) => A(31 downto 0),
      \A[15]\(3) => multiplier_reg_n_13,
      \A[15]\(2) => multiplier_reg_n_14,
      \A[15]\(1) => multiplier_reg_n_15,
      \A[15]\(0) => multiplier_reg_n_16,
      \A[23]\(3) => multiplier_reg_n_21,
      \A[23]\(2) => multiplier_reg_n_22,
      \A[23]\(1) => multiplier_reg_n_23,
      \A[23]\(0) => multiplier_reg_n_24,
      \A[31]\(3) => multiplier_reg_n_29,
      \A[31]\(2) => multiplier_reg_n_30,
      \A[31]\(1) => multiplier_reg_n_31,
      \A[31]\(0) => multiplier_reg_n_32,
      B(31 downto 0) => B(31 downto 0),
      \B[15]\(3) => multiplier_reg_n_9,
      \B[15]\(2) => multiplier_reg_n_10,
      \B[15]\(1) => multiplier_reg_n_11,
      \B[15]\(0) => multiplier_reg_n_12,
      \B[23]\(3) => multiplier_reg_n_17,
      \B[23]\(2) => multiplier_reg_n_18,
      \B[23]\(1) => multiplier_reg_n_19,
      \B[23]\(0) => multiplier_reg_n_20,
      \B[31]\(3) => multiplier_reg_n_25,
      \B[31]\(2) => multiplier_reg_n_26,
      \B[31]\(1) => multiplier_reg_n_27,
      \B[31]\(0) => multiplier_reg_n_28,
      CO(0) => multiplicand_in1,
      D(1) => multiplier_reg_n_34,
      D(0) => multiplier_reg_n_35,
      DI(3) => multiplier_reg_n_1,
