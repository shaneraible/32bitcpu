...
proc create_root_design { parentCell } {
  ...
  # Create instance: Splitter64_32_0, and set properties
  set block_name Splitter64_32
  set block_cell_name Splitter64_32_0
  if { [catch {set Splitter64_32_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Splitter64_32_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net Multiplier_0_R [get_bd_pins Multiplier_0/R] [get_bd_pins Splitter64_32_0/full_pie]
  connect_bd_net -net Multiplier_0_done [get_bd_pins Multiplier_0/done] [get_bd_pins axi_regmap_0/REG2_IN]
  connect_bd_net -net Splitter64_32_0_slice_lsb [get_bd_pins Splitter64_32_0/slice_lsb] [get_bd_pins axi_regmap_0/REG0_IN]
  connect_bd_net -net Splitter64_32_0_slice_msb [get_bd_pins Splitter64_32_0/slice_msb] [get_bd_pins axi_regmap_0/REG1_IN]
