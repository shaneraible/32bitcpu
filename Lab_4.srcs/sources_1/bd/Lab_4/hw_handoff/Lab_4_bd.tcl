...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net CPU_0_MemWrite [get_bd_ports led4_b] [get_bd_pins CPU_0/MemWrite] [get_bd_pins xlconcat_0/In0] [get_bd_pins xlconcat_0/In1] [get_bd_pins xlconcat_0/In2] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net CPU_0_MemoryAddress [get_bd_pins CPU_0/MemoryAddress] [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net CPU_0_MemoryDataOut [get_bd_pins CPU_0/MemoryDataOut] [get_bd_pins blk_mem_gen_0/dinb]
  connect_bd_net -net axi_regmap_0_REG0_OUT [get_bd_ports led5_g] [get_bd_pins CPU_0/Reset] [get_bd_pins axi_regmap_0/REG0_IN] [get_bd_pins axi_regmap_0/REG0_OUT] [get_bd_pins blk_mem_gen_0/rstb]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins CPU_0/MemoryDataIn] [get_bd_pins blk_mem_gen_0/doutb]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins CPU_0/Clock] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_regmap_0/S_AXI_ACLK] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
