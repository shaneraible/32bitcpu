...
# this instruction will add the internal signals and ports of a component name U_1, 
# which in this case is the memory block.
...
#and $11, $7, $11
#sw $11, 15($7)
# you can use any of the following commands as an example on how to initilaize a 
# memory location with a value
# the first 4 memory locations are initialized with the instruction codes 
# correpsonding to the 4 instructions above.
